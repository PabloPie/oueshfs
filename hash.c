...
static unsigned int hash_algo_size;
static struct sdesc *hash_sdesc;
static struct crypto_shash *hash_algo;
...
*/
void hash_to_string(unsigned char *dest, struct hash_sha256 *hash, unsigned int hsize)
{
